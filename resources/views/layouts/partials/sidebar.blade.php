        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            @foreach ($bases as $base)
                                <li><a href="{{route('change_base',['id' => $base->id])}}"><i class="material-icons">folder</i>{{ $base->name }}</a></li>
                            @endforeach
                            <li role="seperator" class="divider"></li>
                            <li><a href="{{route('bases')}}"><i class="material-icons">settings</i>Gestion bases</a></li>
                            <li role="seperator" class="divider"></li>
                ...
                <select id="bases" name="bases">
                    @foreach($bases ?? '' as $base)
                    <option value="{{$base->id}}">Base active : {{$base->name}}</option>
                    @endforeach
                </select>

            </div>

            {{-- {{$active_base==$base->id ? 'selected' : ''}} --}}
            <!-- #User Info -->
            <!-- Menu -->
            <div class="menu">
                <ul class="list">
